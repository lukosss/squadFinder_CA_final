<template>
    <div>
        ...
        <div v-else class="d-flex flex-wrap justify-content-around">
            <b-card no-body class="overflow-hidden mb-3 mr-2" style="max-width: 540px" v-for="game in this.myGames"
                    :key="game.id"
                ...
                <b-row no-gutters>
                    <b-col md="6" class="d-flex justify-content-center align-items-center">
                        <b-card-img style="max-height: 180px; object-fit: cover;"
                                    :src="domain + 'storage/uploads/images/original/' + (getImage(game.game.id) !== undefined ? getImage(game.game.id) : 'default-game-image.png')"
