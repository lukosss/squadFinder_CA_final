        ...
        <b-form @submit.prevent="handleSubmit()">
            ...
            <b-form-group label="Your City" label-for="city_id">
                <b-form-select v-model="selected_city">
                    ...
                    <b-form-select-option v-for="city in this.citiesList" :key="city.id" :value="city.id">{{city.city_name}}</b-form-select-option>
                </b-form-select>
            </b-form-group>
                </div>
...
<!--            <b-form-group label="Profile Logo" label-for="avatar_logo">-->
<!--                <b-form-file-->
<!--                    v-model="file1"-->
<!--                    :state="Boolean(file1)"-->
<!--                    id="avatar_logo"-->
